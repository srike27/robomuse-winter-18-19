...
from rm4_vision.face_detector import FaceDetector
from rm4_vision.lk_tracker import LKTracker
...
class FaceTracker(FaceDetector, LKTracker):
    ...
    def add_keypoints(self, track_box):
        ...
        cv2.ellipse(mask, mask_box, (255,255, 255), -1)
        ...
        if new_keypoints is not None:
            for x, y in np.float32(new_keypoints).reshape(-1, 2):
                ...
                if distance > self.add_keypoint_distance:
                    ...
                    if self.show_add_drop:
                        cv2.circle(self.marker_image, (x, y), 3, (255, 255, 0, 0), -1, 2, 0)
        ...
        for point in self.keypoints:
            ...
            if std_err > outlier_threshold:
                ...
                if self.show_add_drop:
                    ...
                    cv2.circle(self.marker_image, (point[0], point[1]), 3, (0, 0, 255), -1, 2, 0)   
                try:
            ...
            for point in keypoints_z:
                ...
                try:
                    ...
                    if pct_err > self.pct_err_z:
                        ...
                        if self.show_add_drop:
                            # Briefly mark the removed points in red
                            cv2.circle(self.marker_image, (point[0], point[1]), 2, (0, 0, 255), -1)  
                except:
                    pass
        else:
            mse_z = -1
